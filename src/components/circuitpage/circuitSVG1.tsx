...
interface SvgDoorCircuitProps extends React.SVGProps<SVGSVGElement> {
  ...
  const SvgDoorCircuit1 = React.forwardRef<SVGSVGElement, SvgDoorCircuitProps>(
    ...
    >
      ...
      <text
        ...
        onClick={() => onTextClick('X11_C054_3,WH/BN,0.35,1800.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C054_4,BN/YE,0.35,1800.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('GND-P-02_X11,BK,0.5,1685.0,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_SP_DR_DOORILLU,GY/BN,0.35,960.0')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('C028_C262_8,BU,0.35,1040.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('C028_C262_10,YE,0.35,1040.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C010_3,WH/VT,0.35,2320.0,FLRY-A"')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('C028_C262_2,GN,0.35,1040.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C010_2,YE/VT,0.35,2320.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C010_1,VT/WH,0.35,2320.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C60_2,GN/RD,1.0,1555.0,TP_2,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C028_1,BN,0.5,2390.0,LHD && PMA,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('GND-P-02_C054_1_1,BK,0.5,1845.0,FLRY-B')}
      >
...
>
  {"C060 1"}
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('GND-P-02_C054_1_2,BK,0.5,1845.0,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('GND-P-02_C028_1,BK,0.5,2390.0,LHD && PMA,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C60_1,BU/RD,1.0,1555.0,TP_2,ALL,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C61_6,BK,0.35,1625.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C61_1,BN/GN,0.35,1625.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('GND-P-02_C262_6,BK,0.35,335.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('SP_DR_DOORILLU')}
      >
        {"SP_DR_DOORILLU"}
      </text>
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('C061_SP_DR_DOORILLU,GY/BN,0.35,685.0')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C61_2,BU/WH,0.35,1625.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C61_3,GN/BN,0.35,1625.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('SP_DDR_ILLUM,GY/BN,0.35,1360.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('SP_DR_DOOR_GND')}
      >
        {"SP_DR_DOOR_GND"}
      </text>
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('SP_DDR_GND,BK,0.35,635.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C262_9,BU,0.35,1580.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C262_3,YE,0.35,1580.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C262_1,GN,0.35,1580.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C262_7,YE/RD,0.35,1580.0,LHD && PMA,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C054_2L,BN/VT,0.5,1820.0,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('C252_1_SP_DDR_GND,BK,0.35,600.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C252_1,BU/YE,0.35,2105.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('C010_SP_DR_DOORILLU,GY/BN,0.35,1360.0')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C059_1_1,YE/RD,2.5,1760.0,ALL,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('GND-P-02_C010,BK,0.35,635.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C095_1_1,GY/VT,0.35,1760.0,TP_1,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C059_1_2,WH/GN,2.5,1760.0,ALL,FLRY-B')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C61_4,GY/YE,0.35,1625.0,FLRY-A')}
      >
      ...
      <text
        ...
        style={{ cursor: 'pointer' }}
        onClick={() => onTextClick('X11_C095_1_2,VT/OG,0.35,1760.0,TP_1,FLRY-A')}
      >
...
SvgDoorCircuit1.displayName = 'SvgDoorCircuit1';

export default SvgDoorCircuit1;